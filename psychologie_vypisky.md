...
- cesta k cíli, poznání

- vědecká metoda: určitý, přísnými pravidly vymezený postup

- experiment (v praxi pouze výzkum), pozorování, rozhovor, dotazník, psychologické testy, rozbor písemných projevů, anamnéza

Rozbor jednotlivých metod:

Pozorování – je to cílevědomé, soustavné a plánovité vnímání jevů a procesů, které směřuje k odhalení podstatných souvislostí a vztahů sledované skutečnosti

Rozhovor – je výzkumná a diagnostická technika, která spočívá v dotazování, účel získání informací a navázání kontaktu

Dotazník – slouží k zjišťování informací v populaci jako celku nebo i v nějaké menší skupině osob

Psychologický test – jde o souhrnné označení metod, které měří duševní vlastnosti a stavy případně i vlastnosti skupiny osob

Rozbor písemných projevů

Anamnéza – je soubor informací potřebných k bližší analýze zdravotního stavu pacienta, a to zejména z jeho minulosti

Etické aspekty psychologického výzkumu
...
- je nejzákladnější a nejobecnější psychologický pojem

- psyché – duše

- popis lidské osobnosti

- psychika je souhrn duševních dějů během celého lidského života

- jde o schopnost odrážet svými stavy okolní realitu a reagovat na ní (přímá reakce, pochopení okolí, vzájemné vztahy)

- shrnuje veškeré duševní obsahy a funkce člověka – tedy nejen to, co si myslíme a děláme, ale i to jakým způsobem myšlenkové informace zpracováváme, tedy samotný proces tohoto zpracování

- lidská psychika obsahuje

1. procesy – poznávací (slouží k získání a zpracování informací), emoční (emoce, city, požitky), motivační (usměrňují chování)

2. obsah – myšlenky, vzpomínky, fantazie, rychle se mění

3. stavy – dočasné, špatné, deprese, úzkost

- psychologické procesy jsou začleněny v lidských činnostech, funkci mozku, sociální aspekty (komunikace)

Psychický jev

- je sdělitelný (i když ne vždy uvědomovaný), popsatelný a zobecnitelný důsledek odrazu objektivní a subjektivní reality v psychice jedince

- kategorie psychické činnosti člověka, tvořící dynamickou součást komplexního psychického pohybu v rámci psychiky

- působí jako celek, je funkcí mozku

- vlivem společnosti, důležitou roli sehrává výchova

- jevy se mění a vyvíjejí

- mají určité předpoklady – biologické (vlohy dítěte, vlastnosti vyšší NS) a sociologické.

Psychologické jevy dělíme na tři skupiny dle jejich trvání:

1) psychické procesy - součást psychické aktivity jedince, charakterizovaná relativní samostatností

• procesy poznání – nabývání znalostí o reálném světě, tak i jeho výsledek

• pozornost – je zaměřenost a soustředěnost duševní činnosti na určitý objekt nebo děj

• pamětí – je schopnost uchovávat a používat informace o předchozích zkušenostech, dělí se na senzorickou, krátkodobou, střednědobou a dlouhodobou
...
• schopnosti – jsou vlastnosti osobnosti (výcvik, vzdělání, zkušenosti)

• rysy osobnosti – celek individuálního člověka, zaměřeného na realizaci životních cílů a rozvinutí svých možností ve společnosti, existuje spousta definic, ale těžko by jsme hledali tu správnou, nikdo není stejný

• temperament – souhrn charakteristických nebo vrozených rysů osobnosti, které se trvale projevují způsobem reagování, jednání a prožívání

- cholerik – výbušný, agresivní, těžko ovladatelný

- sangvinik – přiměřená reakce (slabé podněty slabá reakce, silné podněty silná reakce)

- flegmatik – klidný, emočně celkem vyrovnaný

- melancholik – smutný, pesimistický

- introvert – člověk žijící svým vnitřním životem, vnímavý ke svému okolí, rozvážný, opatrný
...
• pohyb a funkce lidského organismu

• dýchání, srdeční činnost, pohyb, nervová činnost

• důležitá je koordinace jednotlivých orgánů a funkcí

• nejdůležitější je funkce centrální nervové soustavy - mozek a mícha

Mozek

• hlavní orgán nervové centrální soustavy

• poruchy a poškození mozku ovlivňuje psychickou funkci mozku

• působení chemických látek dochází ke změnám fyziologickým ale i ke změnám prožívání, emocí, pozornosti, náladě, řešení myšlenkových úkolů

Funkce mozku

- důležitou úlohu mají synapse (spojení dvou neuronů) – předávají informace

- mysl –

• je soubor rozumu, vnímaní, vůle, paměti, představivosti a cítění,

• je to lidská záležitost

- instinkt –

• vrozené, genetické reakce či spoje, nepodmíněné reflexy

• účelové chování, které není výsledkem učení a zkušenosti

- učení –

• je proces získávání a předávání zkušeností, návyku, dovedností, znalostí, hodnot a podobně

• tvoření nových spojů a reflexů
...
• je jednoduchá reakce a odpověď na podnět

• dělení reflexu:

- reflexní oblouk – čidlo, dostředivé dráhy, ústředí, odstředivé dráhy, výkonného orgánu

- monosynaptický reflex – nejjednodušší druh reflexu se skládá jen ze dvou nervových buněk

- polysynaptický reflex – do reflexního oblouku je zapojen alespoň ještě jeden další neuron

- nepodmíněné reflexy – jednoduché, zcela automatické reakce, vrozené s trvalým spojením smyslového a výkonného orgánu, za odpovídajících podmínek se dostavují vždy a stereotypně

- podmíněné reflexy - typem učení, na rozdíl od nepodmíněných se podmíněné reflexy vytvářejí pouze jako dočasné, opakovanými situacemi se mohou posilovat nebo naopak vyhasínají

• reflexy se zabýval I.P.Pavlova (psycholog, lékař)

- emoce – 

• jsou psychicky procesy, zahrnující subjektivní zážitky libosti a nelibosti, provázené fyziologickými změnami (změna srdečního tepu, změna rychlosti dýchání atd.), motorickými projevy, změnami pohotovosti a zaměřenosti.
...
- vnímání, počitky, vjemy

- procesy učení a paměti

- imaginativní procesy, představy, fantazie

- myšlení spjaté zejména s řečí a myšlení řešení problémů

- procesy používané v poznávání skutečnosti

Životní funkce poznávacích procesů jsou:
...
- v uvědomování si emocí, v řešení konfliktů, v rozhodování a realizací vytyčených cílů

Všechny tyto funkce na sebe navzájem působí.

- úlohy, které plní poznávací procesy v lidském životě, lze objasňovat na vnímání (příklad: učitelé by se neměli omezovat pouze na slovní sdělování učiva, ale žáci by měli mít možnost (příležitost) k jejích vnímání (smysly))

- v komunikaci, rozhovoru s člověkem má důležitou úlohu vnímání jeho slov, mimiky gestikulace, výrazu

Vnímání

= poznávací proces, který zachycuje to, co v přítomném okamžiku působí na naše smyslové orgány

- k vnímání potřebujeme kromě smyslových orgánů příslušné části v mozku a nervové dráhy

Druhy vnímání

- rozlišují se podle jednotlivých smyslových orgánů

zrakové vnímání

- poznávání předmětů i na větší vzdálenost

- při čtení, psaní, kreslení, prac.činnostech

sluchové vnímání

- informace o předmětech a událostech vzdálených

- při nebezpečí, při vnímání řeči, vnímat a vytvářet hudbu

čich a chuť

- především k odlišování potravy (od látek nebezpečných, nevhodných)

- vnímání vůně květin, parfémů

dotek, chlad a teplo, bolest

- při působení předmětů na naše tělo

- kožní smysly, které slouží k obraně před nebezpečím, ale také k poznávání některých vlastností materiálů (hladký, drsný povrch)

Tyto formy vnímání informují o vnějším světě.

analyzátor pohybový a introceptivní – informace o procesech a stavech uvnitř těla

Analyzátor pohybový (propriceptivní)

- slouží ke kontrole pohybů a polohy jednotlivých částí těla, končetin, hlavy

- vnímání a udržování rovnováhy

- umožňuje přesné pohyby při sportu, práci po delším cviku bez zrakové kontroly

Interocepce (orgánové počitky)

- informuje o změnách ve funkci a stavu vnitřních orgánů (hlad, sytost, nevolnost, bolest)

- informace z pohybového aparátu si plně neuvědomujeme a přesto působí na naší náladu (dobrá nálada, čilost, ochablost, únava)

Jednotlivé druhy vnímání se spojují a tím dosahujeme poznání skutečnosti:

hmat

- slouží ke komplexnímu vnímání

- aktivní ohmatávání předmětů

Ve vnímání rozlišujeme dva druhy zážitků

- počitky

- vjemy

vjem = představuje obraz předmětu nebo procesu jako celku (vjem jablka)

počitek = obraz některého jednotlivého zraku vnímaného předmětu (např. počitek červené barvy, nakyslé chuti)

Nervový systém má rozvinuté mechanismy – k rozlišování částí a dílčích vlastností, tak i k vystižení jejich vztahů, uspořádání.

Vnímání se realizuje složitými neurofyziologickými mechanismy informačních procesů.

- nejprve odlišit podstatnou informaci od šumu, od množství nahodilých podnětů, které na nás působí z prostředí i zevnitř organismu

- dochází k přeměně, transformaci: na fyzikální či chemický proces odpovídá nervový systém procesem fyziologickým, popřípadě psychofyziologickým

- soubor informací se rozčleňuje na části, popřípadě momenty a vystihují se jejich vztahy, uspořádání

- určuje se místo, kde podnět působí na organismus, vystihuje se směr odkud podnět přichází

- informace se zpracovává;nová informace se srovnává s dřívějšími zkušenostmi; to umožňuje zodpovědět otázku ,,Co to je?“

- člověk si vybírá co v daném okamžiku vnímá, ze všeho co na něj působí

- to podstatné a v daném okamžiku vnímané je ,,figura“, vše ostatní tvoří ,,pozadí“

- tyto vjemy se mohou často měnit (figura se změní na pozadí a opačně)
...
- za vrcholný proces lidského poznávání se považuje slovní myšlení (verbální, propoziční; vyjadřuje nějaké tvrzení)

- umožňuje vymezit pojmy, vystihnout vztahy mezi nimi, z jedněch poznatků odvozovat jiné, formulovat hypotézy a ověřovat je

- umožňuje řešit problémy (poznávací,, teoretické a praktické – v technice, organizaci, v osobních vztazích, v každodenním životě)

- zahrnuje soubor procesů, které operují názornými představami, symboly, pojmy, slovy, větami, výroky, principy…

- propoziční myšlení je těsně spjato s řečí

- vnější (mluvená a psaná)

- vnitřní (používáme, když počítáme nebo řešíme problém ,,potichu“ – při obtížném problému přicházíme na řeč vnější, která vede k řešení snáze)

řeč = nástroj myšlení

- řeč slouží ke komunikaci mezi lidmi, mezi generacemi, k přenášení zkušeností, produktů vědy a techniky, kultury, nejrůznějších tradic z generace na generace

- rozvoji propozičního myšlení pomáhá rozvinutí řeči, dobré osvojení jazyka, jeho slovníku, gramatiky

- myšlení vytváří pojmy a dále s nimi operuje

pojem = mentální reprezentace určité skupiny objektů, vystihuje jejich podstatné společné znaky


Příklad:

- vezměme pojem strom a srovnejme je s příslušnou představou

- představa strom je názorný obraz (zpravidla zrakový)

- při vyslovení slova strom se různým lidem vybaví odlišné představy různých stromů listnatých, jehličnatých, popřípadě několik představ za sebou

- naproti pro pojem strom není podstatné, jaká představa se nám při něm vybaví

- podstatné je slovní charakterizování pojmu, pokud možno jeho definice, která shrnuje jeho podstatné znaky

- rozdíl mezi představou a pojmem ukazuje rozdíl mezi myšlením imaginativním a propozičním

Druhy myšlení

- rozlišují se podle několika hledisek

- Z vývojového hlediska tři formy
...
- řešení problému pohybovou manipulací s předměty (tak postupují zvířata a děti, dospělí s rozvinutým intelektem a vysokoškolským vzděláním)

- používá se při řešení složitých problémů, které nezvládáme samotnými slovy a představami: vytvoří si model a řeší na něm problémy

Imaginativní

- pracuje s názornými obrazy, představami

Propoziční

- vývojově nejmladší, operuje se slovy, větami, pojmy

- Imaginativní a motorické myšlení

- je konkrétní

- soustřeďuje se na specifické jevy v jejich celistvosti

Propoziční

- je abstraktní

- operuje s abstraktními, z jednotlivých případů oddělenými momenty

- Deduktivní myšlení

- postupuje od obecných výroků k speciálnějším

Induktivní myšlení

- postupuje od jednotlivých případů k obecnějším informacím

- Reproduktivní myšlení

- při řešení problému opakuje postup, který již byl jedinci znám

Produktivní neboli tvůrčí myšlení

- hledá a tvoří postup nový, jedinci dosud neznámý

- popřípadě postup, který nebyl ještě vůbec nalezen

- Konvergentní myšlení

- směřují k jedinému cíli, k jednomu způsobu řešení daného problému

Divergentní myšlení

- hledá několik různých cest řešení, vede k několika možným řešením

Myšlenkové operace (procesy)

- myšlení se realizuje souborem myšlenkových procesů (operací)

- analýza a syntéza

- rozčlenění celku na části a vystižení toho jak jsou uspořádány dohromady, jaké jsou mezi nimi vztahy

- abstrakce a konkretizace

- postup od celistvých, konkrétních skutečností k odděleným částem, které jsou často důležité pro poznání skutečnosti a pro řešení problému

- a také opak – postup od něčeho abstraktního ke speciálnějšímu

- indukce a dedukce

- viz. indukční a dedukční myšlení

- generalizace, zobecnění

- od jednotlivých případů přechází k obecnému pojmu

- souvisí s předchozími procesy

- srovnávání, uspořádání, třídění (klasifikace)

- nový pojem srovnávám s jinými pojmy, které již znám

- nový problém srovnávám s předchozími problémy

- průnik, sjednocení, negace, implikace
...
* motivace z latinského „movere“ – hýbat, pohybovat, znamená souhrn hybných momentů v činnostech, prožívání, chování osobnosti (to, co člověka podněcuje, pobízí, aby něco dělal, reagoval, nebo naopak, co ho tlumí, co mu zabraňuje něco konat, reagovat), motivace dodává činnosti, našemu prožívání a chování energii a směr, aktivuje a zároveň usměrňuje
...
1. Schéma Maslowovy hierarchie lidských potřeb:1. fyziologické2. bezpečí, jistoty3. lásky, sounáležitosti4. uznání, úcty5. seberealizacezákladna pyramidy–fyziologické potřeby(potřeba potravy, tepla, vyměšování)
...
Toto však nelze říci zcela bezvýhradně, uspokojování vyšších potřeb (estetických, duchovních) může napomoci v mezních situacích lidského života, ve kterých je možnost uspokojování nižších potřeb omezena (např. v prostředí koncentračních táborů, o čemž referovali mj. Viktor Frankl).

Za nejvyšší považuje Maslow potřebu seberealizace, jíž označuje lidskou snahu naplnit své schopnosti a záměry.
...
* S homeostázou souvisí jev nasycení: uspokojení potřeby – to vede na určitou dobu k jejímu oslabení. Nasycení lze vyjádřit také termínem redukce pudu, snížení napětí.
...
4. Dvojitý konflikt kladných a negativních sil – dítě chce vylézt na strom, ale bojí se, přitom je sledováno kamarády a dítě chce získat obdiv svým výkonem, ale zároveň se bojí posměchu v případě nezdaru.
...
* Psychické procesy jsou začleněny v lidských činnostech: herních, učebních, pracovních

* Psychické procesy jsou funkcí mozku

* Mají výrazné sociální aspekty: formulují se ve styku s druhými lidmi

* Mění se a vyvíjejí se

* Jsou spjaty navzájem s psychickými stavy a vlastnostmi osobnosti
...
Motivace je souhrn hybných momentů v osobnosti a v činnosti. Souhrn toho, co člověka pobízí, aby něco dělal, nebo co mu v tom zabraňuje.

Motivace má několik složek: potřeby, emoce, zájmy, postoje, hodnotové orientace, cíle a smysl.

Potřeby

Označení se hodí jak pro vývojově starší (biologické) motivy, tak pro vývojově mladší (sociální, sociogenní) motivy.

= moment, který vede k vyhledávání určité podmínky nezbytné k životu a vývoji a k vyhýbání se nepříznivým podmínkám.

Síla potřeby – je vyjádřena aktivací (tj. energizující moment v motivaci). Druh potřeby je vyjádřen směrováním motivace (k čemu jedinec směřuje).

Výčet potřeb – viz Maslowova teorie (hierarchie) potřeb

Maslow_hierarchy

Členění na nižší a vyšší potřeby, primární a sekundární, nedostatkové a růstové.

Popis obrázku - Maslow:

Naše potřeby jsou hierarchicky uspořádány. Nejdříve uspokojujeme vždy potřeby nižší, teprve po jejich uspokojení potřeby vyšší. Pokud neuspokojíme potřebu nižší, vyšší potřebu si často ani neuvědomíme. Vyšší potřeby vyvstávají vždy až po uspokojení potřeb nižších. (např. student, který opakovaně porušuje pravidlo, že při hodině se nejí, v podstatě potvrzuje Maslowovu teorii. Základní potřeba jídla je silnější, než potřeba bezpečí nebo potřeba poznávání…Pokud si mám vybrat ze dvou zaměstnání, jedno je za minimální mzdu, ale v příjemném pracovním kolektivu, druhé je za průměrný plat, o kolektivu se mlčí, vyberu to druhé, jelikož potřebuji uspokojit základní potřeby. Potřebu přátelského kolektivu začnu řešit až ve chvíli, kdy vím, že mám co jíst a kde spát.)

Čáp s Maslowem úplně nesouhlasí. VŠECHNY potřeby jsou navzájem spjaty, hierarchie neplatí vždycky. Např. pokud nebudu mít v pořádku vztahy v rodině, necítím dostatečné bezpečí. U zvířat je potřeba péče o potomstvo silnější, než potřeba sexuální. Atp.

Potřeby jsou tedy složky motivace, vzájemně se překrývají, pronikají, jsou navzájem spjaté funkčně i vývojově. Ne všechny potřeby si plně uvědomujeme.

Zájmy

Zájem je získaný motiv, je to projev kladného emočního vztahu k určité skutečnosti nebo k určitému druhu činnosti. (hudba, sport, biologie…)

Projevuje se:

- soustředěním pozornosti v daném směru

- realizací dané činnosti, uspokojením z ní

- nelibostí při jejím omezování

a) obsah zájmu (to, o co se zajímám)

b) hloubka zájmu (povrchní x hluboký; přechodný x trvalý)

Zpravidla máme několik zájmů zároveň:

1) Příbuzné a vzájemně se podporující

2) Konflikt mezi dvěma zájmy

3) Kompenzační vztah dvou odlišných zájmů (vyvažování jednostrannosti některých zájmů) Práce je vyvažována koníčkem.

Lidé se stejným zájmem v něm ale mohou uspokojovat různé potřeby (sport – potřeba činnosti, dobrého výkonu, osobních vztahů…).

Postoj

Je to získaný motiv.

Vyjadřuje vztah k určitému objektu, k věci, lidem, činnosti, skupině, události, ideji apod.

Tři složky:

a) Poznání objektu a názory na něj (např. na muslimy)

b) Jeho citové hodnocení (sympatie, antipatie, láska, nenávist, lhostejnost)

c) Pobídka k chování či jednání v souhlasu s názorem a emočním hodnocením

Hodnoty společnosti

Urč. skutečnosti společnost hodnotí jako významné, cenné, je třeba o ně usilovat, chránit je (mír, zdraví, životní prostředí, demokracie, svoboda, spravedlnost)

Hodnotová orientace jedince = postoj jedince k hodnotám společnosti. Lidé se navzájem liší v žebříčku hodnotových orientací či hodnot.

Cíle

Jedinec si je vytyčuje, usiluje o jejich dosažení, popř. nevěří v jejich dosažení nebo jsou pro něj nepřijatelné.

Členění cílů – hlediska:

1) Obsahové – které životní oblasti se cíl týká

2) Čas – blízké (uvařit večeři), střední (zvládnutí přijímací zkoušky na SŠ), dlouhodobé (zaměstnání v oboru, založit rodinu, dosáhnout výsledků v odborné právi nebo v umění…)

3) Význam cíle – pro jedince, malou skupinu, společnost. Ideální je shoda cílů u všech tří, ale předpokládá to rozvinutou osobnost.

Rozdíly v motivaci mezi lidmi:

1) Rozdíly v celkové individuální motivaci – v aktivačním aspektu motivace – lidé mdlí/pasivní nebo nadšení/aktivní.

2) Z obsahového hlediska – E. Spranger – typ člověka teoretický, ekonomický, estetický, sociální, politický, náboženský. Pro každý typ je rozhodující jiná hodnota.

3) Podle motivační šíře –

a) zúžená motivace, několik málo potřeb či zájmů (např. jen práce a vztah) – jednostranné osobnosti
...
– vlastnosti, které člověku umožňují naučit se určitým činnostem a dobře je vykonávat.

- rozvinuté na podkladě vrozených vloh (viz níže)- učením, činností, rozvoj podmíněný výchovou a vyučováním, dalšími spol. podmínkami.

Druhy schopností: verbální (slovní porozumění a myšlení), numerické (početní), prostorové (prostorové představy, názorné řešení problémů), paměťové, dále percepční (vnímání smysly – barvy, zvuky, hmatové vjemy…), umělecké, sportovní, sociální (sociální cítění, komunikace, spolupráce a její řízení)

Inteligence

= schopnost poznávat, myslet a řešit problémy (kognitivní schopnosti). Rozšíření pojmu inteligence (Gardner a Goleman) – interpersonální inteligence (schopnost rozumět druhým), intrapersonální i. (s. poznávat sám sebe a podle toho jednat), emoční inteligence (překrývá se s pojmem charakter, patří tam třeba sebeovládání).

= soubor kognitivních schopností k poznávání, učení a řešení problémů.

Dle míry těchto schopností:

- Obecná inteligence = celková schopnost učit se a řešit problémy

- Speciální intelektové schopnosti = verbální (levá hemisféra mozku), nonverbální (pravá hemisféra - obrazy, schémata), numerické

R.B.Catell:

1) tekutá inteligence (vrozená, do 14ti let)

2) krystalická (zkušenost, výchova, praxe, další vzdělávání; rozvíjí se i v dospělosti)

Zjišťování obecné inteligence (a její struktury)

Inteligenční testy (viz standardizované psychodiagnostické metody)

Poměr mezi mentálním věkem jedince a fyzickým věkem (IQ=MV/FVx100).

Přesnější je srovnání momentálního výkonu jedince se zbytkem populace. (vysoký nadprůměr (nad 130), nadprůměr 120-130, lehký průměr 110-120, průměr 90-110 (50% populace), lehký podprůměr 80-90, hraniční pásmo defektu (70-80), mentální retardace (lehká - debilita, střední - imbecilita, těžká - idiotie).

Výsledek měření vždy závisí i na dalších podmínkách – vědomosti, dovednosti, motivace, pozornost, zdravotní stav, konflikty v rodině nebo s vrstevníky

Další pojmy: vloha, nadání, dovednosti, talent, genialita

Vloha - biologický, vrozený předpoklad pro rozvinutí schopností. Vlohy nedokážeme zjišťovat, zjišťujeme vždy až schopnosti.

Nadání - soubor dobře rozvinutých schopností pro určitou oblast (matematika, jazyky, umění...)

Talent/genialita - zvlášť vysoký až zcela výjimečný stupeň schopností či nadání

Dovednosti - těsně souvisejí se schopnostmi, nelze pojmově přesně odlišit. Např. vyučování jazyků - dovednosti pravopisu, mluvnice, slohu, překladu...Osvojení je ale závislé na schopnostech. Upevňují se cvikem, činností, praxí. Po delší dobu, vede k rozvinutí verbální schopnosti.

Tvůrčí schopnosti, tvořivost, kreativita

Tvořivost (kreativita)

- soubor vlastností osobnosti, které umožňují tvůrčí činnost

- tvůrčí řešení problémů (tj. dosud známá schémata řešení selhala, bylo nutno hledat nový způsob řešení)

Tvůrčí činnost = taková činnost, která přináší nějaký nový výsledek. K jeho dosažení nebyla řešiteli známa cesta, schéma řešení, nestačil rutinní postup.

Tradičně: tvořivost je zcela mimořádná schopnost (vrozená vloha), dána jen výjimečným jedincům (geniální umělci, vědci, vynálezci).

Výzkumy: tvůrčí řešení u těchto osobností závisí na rozsáhlé zkušenosti, silné motivaci, vytrvalé práci, vědomostech, dovednostech, sebeovládání, odpovědnosti. Okamžik inspirace nebo nápadu je v podstatě připraven dlouhou prací dopředu.

Tvořivost = soubor vlastností a dalších osobních předpokladů, které umožňují tvůrčí činnost, popřípadě tvůrčí řešení problémů.

Je inteligence nutně součástí tvořivých osobností? Převládající názor: není. Tvořivost není totéž co inteligence. A zároveň, osobnost s nadprůměrnou inteligencí nemusí být zároveň vysoce kreativní.

Dvě formy myšlení:

1) konvergentní - elementárnější (jednodušší), úlohy jsou spíše přesně vymezeny, známý postup, jediné správné řešení

2) divergentní - náročnější zadání, umožňuje využít několik postupů, několik odlišných řešení.

Je možné, že tvořiví jedinci mají rozvinuté právě divergentní myšlení.

Tvořivé děti:

Je potřeba zvláštní diagnostika.

Většinou nemají snadný život, učitelé a vrstevnívi brzdí rozvíjení kreativity.

Učitelé: jsou méně poslušné a poddajné, neobvyklé nápady, nepříjemné dotazy, chybí jim střízlivé myšlení.
...
- Osobnost = souhrn vlastností, procesů, stavů, návyků, postojů apod., které tvoří celistvou strukturu a dynamiku, individualitu konkrétního člověka. Každá osobnost má své jedinečné psychické, biologické a sociální vlastnosti
...
- Eysenckovy dvojice rysů: extraverze – intraverze; stabilita – labilita

dominance – submise; hostilita – afiliace

-důkladný systém faktorů osobnosti podle R.B. Cattella (1970) – 16 faktorů osobnosti, 14 faktorů -osobnosti pomocí dotazníku pro mladistvé

-pol. 20 stol. - BIG FIVE (velká pětka) – 5 zákl. Faktorů osobnosti

-rys osobnosti je znázorněn jako dimenze mezi dvěma póly, mezi krajními, protikladnými formami

-osobnost je celistvá, jednotlivé rysy se vzájemně překrývají či pronikají

- 5 faktorů BIG FIVE:

1. Extraverze – hovorný, výmluvný, temperamentní, společenský, sdílný aj. protikladem je introverze (málomluvný, tichý, samotářský, plachý, nesmělý)

2. Přívětivost – dobrosrdečný, dobrotivý, přívětivý, srdečný, zdvořilý, charakterní aj. protikladem je negativní vztah k lidem (panovačný, útočný, pomstichtivý, necitelný, agresivní aj.)

3. Svědomitost – důkladný, důsledný, pilný, pečlivý, pracovitý, vytrvalý, spolehlivý aj. protikladem je nesvědomitost (lenivý, nevytrvalý, chaotický, nestabilní aj.)

4. Emoční stabilita – klidný, vyrovnaný, duchapřítomný, dovedný, sebejistý, odolný aj. protikladem je labilita (rozrušitelný, vznětlivý, neklidný, úzkostlivý, zlostný aj.) 

5. Intelekt, kultura, otevřenost ke zkušenosti – inteligentní, chytrý, bystrý, vzdělaný aj. protikladem je přihlouplý, neinteligentní, omezený, neučenlivý aj.

- Kombinovaný přístup jednotlivých autorů je rozdělen na 3 druhy komponent:


1. kognitivní komponenty

2. motivačně- emoční komponenty

3. návyky a dovednosti ( konativní nebo behaviorální)

- například afiliace – hostilita (láska - nenávist) zahrnuje:

1. názor na člověka a jeho povahu – dobré nebo špatné lids. povahy

2. sympatii, lásku nebo antipatii, nenávist k lidem

3. dovednosti a návyky chování empatického, kooperativního, altrustického nebo bezohlédného, egoistického, agresivního

- rysy a vnější podmínky působí ve vzájemné interakci = interakcionismus

- u mladistvých je např. vyrvalost a svědomitost se rozlišuje podle 3 oblastí života : v učení, v práci, v zájmové činnosti

PSYCHICKÉ JEVY OSOBNOSTI

- jsou navzájem spojeny a působí jako celek, což se projevuje v osobnosti člověka; jsou funkcí mozku, zformovaly se vlivem společnosti (působením výchovy); umožňují člověku poznávat svět a aktivně na něj působit; v průběhu života se mění a vyvíjejí; způsobují rozdíly mezi lidmi i rozdíly v jednotlivých etapách života jedince

• psychické vlastnosti (dispozice) osobnosti - temperament, schopnosti, charakter, motivy a postoje, volní vlastnosti

• psychické procesy osobnosti

- poznávací (kognitivní) procesy – vnímání, představa, fantazie, myšlení, řeč

- procesy paměti (paměť - zapamatování, uchování, vybavení; učení)

- motivační procesy (citové a volní)

• psychické stavy osobnosti – stavy pozornosti, citové stavy

PSYCHICKÉ VLASTNOSTI OSOBNOSTI

TEMPERAMENT

- část osobnosti, která je určována především biologicky a projevuje se způsobem citového reagování
...
tzv. sangvinik, cholerik, flegmatik, melancholik

podle I.P.Pavlova 4 typy temperamentu:

- síla - slabost (odolnost k zátěži)

- vyrovnanost - nevyrovnanost (síla procesu podráždění a útlumu)

– pohyblivost – inertnost (rychlost zvládnutí přecházet od jedné činnosti k druhé)
...
- zjišťuje se pomocí inteligenčních testů, vyjádřena pomocí inteligenčního kvocientu (IQ 80 – hranice defektu, IQ 100 – průměr, IQ 120 a více – nadprůměr)
...
- druhá část osobnosti, která je determinována převážně sociálně, má společenský a morální význam

- souhrn psychických vlastností osobnosti, na jejich základě se člověk chová ustáleným způsobem v konkrétních situacích; utváří se po celý život působením výchovy a dalších společenských jevů, základní struktura mezi 30. a 35. rokem
...
- pohnutky, psychologické příčiny reakcí, činností a jednání člověka zaměřené na uspokojování potřeb

Potřeba – základním druhem motivu, subjektivně pociťovaný nedostatek (nadbytek) něčeho nezbytného pro život jedince; dělíme na:

• biologické (primární, vrozené) – potřeba dýchat, jíst, spát apod.

• sociální (získané) – kulturní (vzdělání, kulturní život) a psychické (radost, štěstí, láska apod.)

ABRAHAM MASLOW – autor stupňovitého řazení potřeb podle naléhavosti:

1) fyziologické p.

2) p. bezpečí a jistoty

3) p. lásky a sounáležitosti

4) p. uznání a ocenění

5) p. sebeaktualizace, seberealizace, poznávání, estetické p.

- potřeba vyšší se objevuje až po uskutečnění potřeby nižší

Další motivy: pud, zájem, aspirace (ambice), cíl, ideály, zvyk

POSTOJE

- sklony člověka reagovat ustáleným způsobem na předměty, osoby a situace; odrážejí hodnotící vztah člověka k určité skutečnosti

- tři složky:

1) poznání objektu, názory na něj

2) citové hodnocení objektu, sympatie – antipatie 

3) pobídka k jednání či chování

Rozdíl mezi motivy a postoji:

Motivy aktivizují chování, postoje se projevují v jeho obsahu (např. motiv mateřské péče je aktivován křikem dítěte, způsob reakce matky závisí na jejím postoji k dítěti)

VOLNÍ VLASTNOSTI

- vlastnosti podmíněné vůlí člověka; vyjadřují cílevědomé úsilí směřující k dosažení vědomě vytyčeného cíle, které je vlastní jen člověku (např. odpovědnost, vytrvalost, spolehlivost, zásadovost, sebekritičnost…)
...
- E. L. THORNDIKE (1874-1949) – pokusy se zvířaty

W. KÖHLER (1887-1967) – myšlení při učení, okamžik „vhledu“ do situace

H. EBBINGHAUS (1850-1909) – zapamatování a zapomínání, křivka zapomínání
...
- přechodné, mění se podle času a situace, vyjadřují celkové psychické prožívání člověka v určitém okamžiku
...
a) fáze orální (0-1 rok): ústa jsou prostředek k seznámení se světem, cucání palce – uspokojování bez cizí pomoci, kouření – následek nedostatečného kojení

b) fáze anální (2-3 roky): zdrojem uspokojení anální oblast – vylučování

c) fáze falická (3-6 let): zájem se přenáší na genitálie

- Oidipův komplex – podvědomý erotický vztah syna k matce spojený se strachem z trestu, otec je pociťován jako sexuální soupeř, syn se jej snaží odstranit a zastat jeho funkci

- Elektřin komplex – ženská forma Oidipova komplexu, tedy podvědomý erotický vztah dcery k otci

d) fáze latentní (vstup do školy)

e) fáze genitální (dospívání)
...
- povrchnost, mělké city, přílišná sdílnost, snadná ovlivnitelnost, nedůslednost, výbušnost

• cholerik (žluč)

- silný, nevyrovnaný, citově nevyrovnaný směrem k hněvu a agresivitě

- sebevědomí, vášnivost, samostatnost, obětavost, otevřenost, sdílnost, pečlivost, vůdcovství
...
- přecitlivělost, pesimismus, zasmušilost, uzavřenost, samotářství, plachost, roztržitost, bázlivost, vztahovačnost, egoismus

2. Konstituční typologie

-tvrdí, že stavba těla je určujícím faktorem psychických vlastností

a) dr. KRETSCHMER (19. – 20. st.)
...
* vývoj osobnosti je individualizovaný – neprobíhá podle jediného schématu, ale je to soubor různých životních drah, to je vyjádřeno v koncepci celoživotního běhu = biodromální psychologie (z řečtiny bios – život, dromos – běh, průběh)
...
a) novorozenec (28 dnů po porodu)

- komunikace s matkou – sluchem rozlišuje matčin hlas (možno i hlas otce)

- zrakem vnímá předměty vzdálené 20-30 cm

- dokáže sledovat očima podnět, který ho upoutal (nejčastěji lidské obličeje)

- důležitý je dotek

b) kojenec (29. den – 1 rok života dítěte)

- aktivní účastník komunikace s matkou a jinými osobami – přivolává své lidi křikem,

upoutává pozornost druhých úsměvem

- upevňuje se vztah mezi matkou a dítětem – citové pouto

- vyvíjí se základní psychomotorické dovednosti (pohyby, vnímání, poznávání a myšlení, řeč, emoce, komunikace, …)

- důležité období pro vývoj řeči – sleduje řeč matky i ostatních a snaží se napodobovat (broukání, žvatlání, první slabiky, skládání slabik, …)
...
- osamostatňování dítěte (od matky) – kolem dítěte jsou i jiné osoby …

- jsou rozdíly mezi dětmi – „mazlivé“ x „nemazlivé“, …

- další rozvoj psychomotorických schopností a dovedností – pohyby, vnímání, elementární poznávání a myšlení, řeči, učení, emocí, komunikace, vytváření vztahů k prostředí,

rozvíjí se záměrné jednání (např. plácání do chrastítek k vyvolání zvuku)

- dítě si začíná uvědomovat své vlastní tělo, své vlastní aktivity, působení na prostředí
...
- zdokonaluje se jemná motorika

- dítě se naučí ovládat své vylučování

- rychle se rozvíjí řeč – dítě více rozumí a samo aktivně rozšiřuje svou slovní zásobu, začíná klást otázky „Co to je?“, „Proč…?“
...
- získávání zkušeností v sociálních vztazích a komunikaci s vrstevníky

- důležité zařazovat vhodná výchovná zaměstnání, která rozvíjí vnímání, představy, myšlení, řeč a jiné dovednosti dítěte

- dítě se učí soustředění ve skupině dětí = příprava pro školu a prevence adaptačních problémů při vstupu do školy

- dobře fungující MŠ podporuje spontánnost dítěte
...
- období pohlavního dospívání a nového začleňování osobnosti do společnosti

- období změn ve vývoji osobnosti a problémů v rodinné i školní výchově
...
- začíná prvními náznaky pohlavního dospívání (sekundární pohlavní znaky a výrazný růst do výšky)

- trvá přibližně od 11 do 13-14 let

- začleňování do skupiny vrstevníků, navazování trvalejších kamarádských vztahů

- získávání zkušeností v sociální interakci (mezilidské vztahy) a komunikaci

- v období 8-13 let se projevuje pečovatelské chování k malým dětem – získává radostné emoční zkušenosti při hře s nimi

- projevuje se motivace ke komunikaci se zvířaty – někdy tím kompenzuje nedostatky v emočních vztazích mezi lidmi; styk se zvířaty pomáhá rozvíjet komunikaci a vcítění se do druhého, empatii a péči

- v pubertě nastávají výrazné změny:

a) biologické změny:

- růst do výšky, změna proporcí těla, přiblížení se tvarům těla dospělých

- sekundární pohlavní znaky a funkce pohlavních orgánů

b) psychické změny:

- zvýšená nervová labilita, náladovost, podrážděnost, snadno se unaví, …

- vyvíjí se intelekt – formální operace a abstraktní myšlení (značná část mladistvých tyto možnosti ale nevyužívá díky nedostatečné motivaci a množství emočních a sociálních problémů)
...
na tyto změny reaguje okolí pubescenta – tím více si dospívající změny uvědomují a pokouší se s nimi vyrovnat = zátěž pro dospívajícího

- pubescenti porovnávají svůj vzhled s ideálem – obraz vlastního těla a zevnějšku je součást sebepojetí a sebehodnocení;

hledají odpověď na otázky „Kdo jsem vlastně já, o co mi v životě jde?“, „Jak se na mně dívají druzí?“, …

- někteří psychologové označují pubertu jako 2. fázi vzdoru (1. fáze je v batolecím období ve 2-3 letech)

- někteří „ze zásady“ odmítají názory, postoje, příkazy a zákazy rodičů → zátěžová situace pro rodiče i pro mladistvé

- potřebuje se osvobodit od závislosti na rodině

- pubescent se identifikuje s vrstevníky (pokračuje z prepuberty), přejímá jejich názory, normy, způsoby vyjadřování, gestikulaci, styl hudby, …

po osamostatnění od rodiny může vést do další závislosti → další vývoj – uvolnění se ze závislosti na skupině vrstevníků, vytvoření si kritického postoje vůči této skupině

- erotické vztahy a sex – součást lidského života vzbuzující zájem už od dětství (reklama, chování dospělých a medializace prezentuje sex jako velmi důležitou součást života), první zkušenosti jsou spíše rozčarováním

- problémem je i směrování k budoucí profesi – volba budoucího povolání
...
- období po pubertě, asi od 15 do 20 let

- klidnější období než puberta, dochází ke zklidnění vztahu mezi rodiči a dětmi

- dokončuje se tělesný růst a pokračuje společenské zařazování a přechod do dospělosti

vývoj:

a) biologické a psychické hledisko:

- většinou v tomto období dochází k 1. pohlavnímu styku → další problémy a nutnost řešit je, vyrovnání se s náročnými životními situacemi
...
b) sociální aspekty – 2 důležité mezníky sociálního vývoje:

- ukončení povinné školní docházky

- ukončení středního vzdělání – vyučení, maturita, vstup do zaměstnání nebo na VŠ

- pokračování formování sociální identity – nejsou dětmi ani dospělými – děti už být nechtějí a k dospělosti mají rozporuplné pocity = psychosociální moratorium – mladistvý se sněží zpomalit, zastavit vývoj, zdržet se v období mládí „bez povinností“ (časté přání prodloužit si dobu studia), cestovat, „užít si volnosti“,přitom těžce nesou, když je dospělí považují za nedospělé adolescenti pokračují v úsilí o nezávislost na rodičích a jiných dospělých, chtějí mít svou cestu, názory, kulturu, způsob života, … (energicky odmítají jiné názory a životní hodnoty)

- fyzická síla a atraktivita dívek některým usnadňuje získat uznání druhých, posílit své sebehodnocení, budovat svou identitu – to je pomíjivé, spolehlivější je získat jistotu na vzdělání, schopnostech, výkonech, komunikačních dovednostech a charakterových rysech

- formování vlastního „já“, vlastní identity zahrnuje krizi (pochybnosti, váhání mezi možnostmi ve volbě např. povolání, partnera, životního stylu, …), její řešení, přijetí závazku a úsilí při jeho realizaci
...
a) mladá dospělost (20-30 let)

b) střední dospělost (30-45 let)

c) pozdní dospělost (od 45 do 60-65 let)

2) stáří (65 a více let)

- Ve vývoji osobnosti jsou velké individuální rozdíly, a to v každém jednotlivém období i v průběhu celého života.
